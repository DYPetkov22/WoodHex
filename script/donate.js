...
const tree2 = new URL("../photos/donate/Evergreen-Tree.glb", import.meta.url);
const tree3 = new URL("../photos/donate/Birch-Tree.glb", import.meta.url);
...
function edge() {
  ...
  line = new THREE.LineSegments(
    edges,
    new THREE.LineBasicMaterial({ color: "rgb(22, 167, 255)" })
  );
  line1 = new THREE.LineSegments(
    edges1,
    new THREE.LineBasicMaterial({ color: 0xffffff })
